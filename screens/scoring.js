...
export default class ScoringPage extends Component {
  ...
  render() {
    ...
    return (
      ...
      <ImageBackground 
      source={require("../components/scoringImage.jpeg")}
      ...
      <View style={{marginTop: 20}}>
        ...
        <TouchableOpacity
          ...
          >
            <Text style={[styles.buttonText,{color: this.state.finished? "#000000":"transparent"}]}>查看難題</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => {
              navigate("First")
            ...
            style={[styles.button,{backgroundColor: this.state.finished? "#FFE4B5":"transparant"}]}
          >
            <Text style={[styles.buttonText,{color: this.state.finished? "#000000":"transparent"}]}>回到首頁</Text>
          </TouchableOpacity>
          </View>
          </View>
          </ImageBackground>
